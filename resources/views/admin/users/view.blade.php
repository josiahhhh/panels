                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>When a role is assigned the user will be displayed as Administrator, despite this the affected person will only have the permissions of the given role.</small></p>
                        </div>
                    </div>
                </div>
            </div>
