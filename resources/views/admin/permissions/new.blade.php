                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td class="col-sm-3 radio radio-primary text-center">
                                    <input type="radio" id="r11" name="addresses" value="1">
                                    <label for="r11">Read</label>
                                </td>
                                <td class="col-sm-3 radio radio-primary text-center">
                                    <input type="radio" id="rw11" name="addresses" value="2">
                                    <label for="rw11">Read &amp; Write</label>
                                </td>
                                <td class="col-sm-3 radio text-center">
                                    <input type="radio" id="n11" name="addresses" value="0" checked>
                            ...
                            <tr>
                                ...
                                <td class="col-sm-3 radio radio-primary text-center">
                                    <input type="radio" id="r12" name="addresses" value="1">
                                    <label for="r12">Read</label>
                                </td>
                                <td class="col-sm-3 radio radio-primary text-center">
                                    <input type="radio" id="rw12" name="addresses" value="2">
                                    <label for="rw12">Read &amp; Write</label>
                                </td>
                                <td class="col-sm-3 radio text-center">
                                    <input type="radio" id="n12" name="addresses" value="0" checked>
                            ...
                            <tr>
                                ...
                                <td class="col-sm-3 radio radio-primary text-center">
                                    <input type="radio" id="r13" name="subdomains" value="1">
                                    <label for="r13">Read</label>
                                </td>
                                <td class="col-sm-3 radio radio-primary text-center">
                                    <input type="radio" id="rw13" name="subdomains" value="2">
                                    <label for="rw13">Read &amp; Write</label>
                                </td>
                                <td class="col-sm-3 radio text-center">
                                    <input type="radio" id="n13" name="subdomains" value="0" checked>
                            ...
                            <tr>
                                ...
                                <td class="col-sm-3 radio radio-primary text-center">
                                    <input type="radio" id="r14" name="mods" value="1">
                                    <label for="r14">Read</label>
                                </td>
                                <td class="col-sm-3 radio radio-primary text-center">
                                    <input type="radio" id="rw14" name="mods" value="2">
                                    <label for="rw14">Read &amp; Write</label>
                                </td>
                                <td class="col-sm-3 radio text-center">
                                    <input type="radio" id="n14" name="mods" value="0" checked>
                            ...
                            <tr>
                                ...
                                <td class="col-sm-3 radio radio-primary text-center">
                                    <input type="radio" id="r15" name="backups" value="1">
                                    <label for="r15">Read</label>
                                </td>
                                <td class="col-sm-3 radio radio-primary text-center">
                                    <input type="radio" id="rw15" name="backups" value="2">
                                    <label for="rw15">Read &amp; Write</label>
                                </td>
                                <td class="col-sm-3 radio text-center">
                                    <input type="radio" id="n15" name="backups" value="0" checked>
