                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <input id="port_range" name="port_range" class="form-control" value="{{ old('port_range', $egg->port_range) }}">
                                <p class="text-muted small">Port range for egg changes in this format: <code>min-max</code>. Like: 25550-25560</p>
                            </div>
                            <div class="form-group">
                                <label for="root_directory" class="form-label">Root Directory</label>
                                <input id="root_directory" name="root_directory" class="form-control" value="{{ old('root_directory', $egg->root_directory) }}">
                                <p class="text-muted small">Leave empty if you don't want to modify it.</p>
                            </div>
                            <div class="form-group">
