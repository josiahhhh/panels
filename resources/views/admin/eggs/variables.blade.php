                ...
                <form action="{{ route('admin.nests.egg.variables.edit', ['egg' => $egg->id, 'variable' => $variable->id]) }}" method="POST">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="sort_priority" class="form-control" value="{{ $variable->sort_priority }}" />
                            <p class="text-muted small">Defines the variable priority when sorting the variables for display in the startup settings. Variables with higher numbers will appear above ones with lower numbers. </p>
                        </div>
                    </div>
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('admin.nests.egg.variables', $egg->id) }}" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="form-label">Sort Priority</label>
                        <input type="number" name="sort_priority" class="form-control" value="{{ old('sort_priority', 0) }}" />
                        <p class="text-muted small">Defines the variable priority when sorting the variables for display in the startup settings. Variables with higher numbers will appear above ones with lower numbers. </p>
                    </div>
                </div>
