                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <input id="port_range" name="port_range" class="form-control" value="{{ old('port_range') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="root_directory" name="root_directory" class="form-control" value="{{ old('root_directory') }}">
