        ...
        <div class="col-sm-6">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="pLocationId" class="form-label">Linked Location</label>
                        <select name="location_id" id="pLocationId" class="form-control">
                            <option value="">None</option>
                            @foreach($locations as $location)
                                <option value="{{ $location->id }}" {{ $host->location_id !== $location->id ?: 'selected' }}>{{ $location->long }} ({{ $location->short }})</option>
                            @endforeach
                        </select>
                        <p class="text-muted small">This setting will set the database as the default for nodes in the location that don't have a linked database host.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="username" id="pUsername" class="form-control" data-lpignore=true value="{{ old('username', $host->username) }}" />
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="password" id="pPassword" class="form-control" data-lpignore=true />
