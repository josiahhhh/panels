                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="form-group col-xs-6">
                                    ...
                                    <p class="text-muted small">The total number of backups (or size in GB if next option is enabled) that can be created for this server.</p>
                                </div>
{{--                                <div class="form-group col-xs-6">--}}
{{--                                    <label for="backup_limit_by_size" class="control-label">Limit Backups by Size</label>--}}
{{--                                    <div>--}}
{{--                                        <input name="backup_limit_by_size" type="checkbox" value="1" @if($server->backup_limit_by_size) checked @endif />--}}
{{--                                    </div>--}}
{{--                                    <p class="text-muted small">If enabled, database backups are limited by their total size in gigabytes. </p>--}}
{{--                                </div>--}}
                            </div>
                        </div>
                    </div>
