            ...
            <div class="box">
                ...
                <div class="box-body row">
                    <div class="form-group col-xs-6">
                        ...
                        <div>
                            <input type="text" id="pDatabaseLimit" name="database_limit" class="form-control" value="{{ old('database_limit', 1) }}"/>
                        </div>
...
{{--                        <div>--}}
{{--                            <input name="backup_limit_by_size" type="checkbox" value="1" {{ \Pterodactyl\Helpers\Utilities::checked('backup_limit_by_size', 1) }} />--}}
{{--                        </div>--}}
