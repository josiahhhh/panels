        ...
        <div class="col-sm-6">
            <div class="box">
                ...
                <div class="box-body row">
                    ...
                    <div class="form-group col-xs-12">
                        <label for="ip_address" class="control-label">Node IP Address</label>
                        <div>
                            <input type="text" autocomplete="off" name="ip_address" class="form-control" value="{{ old('ip_address', $node->ip_address) }}" />
                        </div>
                        <p class="text-muted">
                            <small>
                                Please enter the node IP address to be used for references to direct node connections.
                            </small>
                        </p>
                    </div>
                    <div class="form-group col-xs-12">
                    ...
                    <div class="form-group col-xs-12">
                        <div class="checkbox checkbox-primary no-margin-bottom">
                            <input id="pForceOutgoingIp" name="force_outgoing_ip" type="checkbox" value="1" @if($node->force_outgoing_ip) checked @endif />
