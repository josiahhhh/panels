import { FractalPaginatedResponse, FractalResponseData, FractalResponseList, getPaginationSet, PaginatedResult } from '@/api/http';
...
function toPaginatedSet<T extends TransformerFunc<Model>>(response: FractalPaginatedResponse, transformer: T): PaginatedResult<ReturnType<T>> {
    return {
