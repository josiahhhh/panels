...
const ServerResult = styled(Link)`
    ${tw`flex items-center bg-icelinebox-500 p-4 rounded border-l-4 border-icelinebox-500 no-underline transition-all duration-150`};
    ...
    return (
        ...
        >
            {({ isSubmitting }) => (
                <Modal {...props}>
                    <Form>
                        <FormikFieldWrapper name={'term'} label={'Search term'} description={'Enter a server name, uuid, or allocation to begin searching.'}>
                            <SearchWatcher />
