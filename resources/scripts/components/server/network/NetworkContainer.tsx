                ...
                <>
                    {data.map((allocation) => (
                        <AllocationRow
                            ...
                            allocation={
                                eggName.includes('FiveM') || eggName.includes('RedM')
                                    ? {
                                          ...allocation,
                                          notes: 'IP for connecting to the server - NOT FOR LICENSE KEYS OR THIRD PARTY SCRIPTS ',
                                      }
                                    : allocation
                            }
                            locked={eggName.includes('FiveM') || eggName.includes('RedM')}
                        />
                    ))}
                    {(eggName.includes('FiveM') || eggName.includes('RedM')) && (
                        <AllocationRow
                            ...
                            allocation={{
                                ...
                                alias: '',
                                port: 0,
                                notes: 'Use for license keys and whitelisting third-party scripts.',
                                isDefault: true,
                            }}
                            locked
                        />
