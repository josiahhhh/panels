...
const theme = {
    background: th`colors.icelinemainbackground.800`.toString(),
    cursor: 'transparent',
...
export default () => {
    ...
    const handleConsoleOutput = (line: string, prelude = false) => terminal.writeln((prelude ? TERMINAL_PRELUDE : '') + line.replace(/(?:\r\n|\r|\n)$/im, '') + '\u001b[0m');
