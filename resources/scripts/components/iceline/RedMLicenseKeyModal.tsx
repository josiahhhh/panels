...
export default ({ visible, onDismissed }: Props) => {
    ...
    return (
        <Modal visible={visible} dismissable onDismissed={onDismissed}>
            <h1 css={tw`text-lg font-medium mb-4 text-neutral-50`}>RedM License Key</h1>
            <div>
                <p css={tw`text-base font-normal mb-4 text-neutral-100`}>
                    Please go to the <a href='http://keymaster.fivem.net/'>FiveM Keymaster</a> to register a new key.
                </p>
