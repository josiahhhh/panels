                    ...
                    >
                        ...
                        <Form css={tw`m-0`}>
                            ...
                            <p css={tw`text-xs mt-2 text-neutral-400 break-all`}>
                                ...
                                &nbsp;/home/container/
                                <span css={tw`text-cyan-200`}>{join(directory, values.directoryName).replace(/^(\.\.\/|\/)+/, '')}</span>
                            </p>
                            <div css={tw`flex justify-end`}>
                                <Button css={tw`mt-8`}>Create Directory</Button>
                            </div>
                        </Form>
                    </Modal>
                )}
            </Formik>
            <Button size={'xsmall'} isSecondary onClick={() => setVisible(true)} className={className}>
                Create Directory
            </Button>
        </>
    );
