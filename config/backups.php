...
return [
    ...
    'disks' => [
        ...
        // Configuration for storing backups in Backblaze B2.
        'b2' => [
            'adapter' => Backup::ADAPTER_BACKBLAZE_B2,

            // The Account ID/Key ID for authorizing the Backblaze B2 requests.
            'key_id' => env('B2_KEY_ID'),

            // The Application Key for authorizing the Backblaze B2 requests.
            'application_key' => env('B2_APP_ID'),

            // The name of the bucket for b2 backups
            'bucket_name' => env('B2_BACKUPS_BUCKET'),
            'bucket_id' => env('B2_BACKUPS_BUCKET_ID'),

            // The name of the bucket for b2 database backups
            'database_bucket_name' => env('B2_DB_BACKUPS_BUCKET'),
            'database_bucket_id' => env('B2_DB_BACKUPS_BUCKET_ID'),
        ]
    ],
];
