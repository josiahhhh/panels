...
class Permission extends Model
{
    ...
    const ACTION_DATABASE_BACKUP_READ = 'database_backup.read';
    const ACTION_DATABASE_BACKUP_CREATE = 'database_backup.create';
    const ACTION_DATABASE_BACKUP_UPDATE = 'database_backup.update';
    const ACTION_DATABASE_BACKUP_RESTORE = 'database_backup.restore';
    const ACTION_DATABASE_BACKUP_DELETE = 'database_backup.delete';
    const ACTION_DATABASE_BACKUP_DOWNLOAD = 'database_backup.download';
    ...
    protected static $permissions = [
        ...
        'logs' => [
            ...
            'keys' => [
                ...
                'delete' => 'Allows a user to delete all the logs for this server.',
            ],
        ],
        ...
        'file' => [
            ...
            'keys' => [
                ...
                'download' => 'Allows a user to download file from url.',
            ],
        ],
        ...
        'database_backup' => [
            'description' => 'Permissions that control a user\'s ability to generate and manage database backups.',
            'keys' => [
                'create' => 'Allows a user to create new database backups for this server.',
                'read' => 'Allows a user to view all database backups that exist for this server.',
                'update' => '',
                'delete' => 'Allows a user to remove database backups from the system.',
                'download' => 'Allows a user to download database backups.',
                'restore' => 'Allows a user to restore a database backup onto the server.',
            ],
        ],
        ...
        'settings' => [
            ...
            'keys' => [
                ...
                'update' => 'Allows a user to trigger a server update.'
            ],
        ],
        ...
        'mods' => [
            ...
            'keys' => [
                'manage' => 'Create and remove mods for current server.',
            ],
        ],

        'transfer' => [
            'description' => 'Manage server transfers',
            'keys' => [
                'manage' => 'Manage moving the service between locations.',
            ],
        ],

        'plugins' => [
            'description' => 'Install Minecraft plugins on the server',
            'keys' => [
                'manage' => 'Manage installing and removing plugins via the plugin manager.',
            ],
        ],
