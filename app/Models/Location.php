 ...
 *
 * @property bool $user_transferable
 * @property string $transfer_allowed_egg_ids
 *
...
class Location extends Model
{
    ...
    public static $validationRules = [
        ...
        'user_transferable' => 'sometimes|boolean',
        'transfer_allowed_egg_ids' => 'sometimes'
    ];
