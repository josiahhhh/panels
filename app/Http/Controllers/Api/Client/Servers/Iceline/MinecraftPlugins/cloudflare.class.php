<?php
namespace Pterodactyl\Http\Controllers\Api\Client\Servers\Iceline\MinecraftPlugins;

use GuzzleHttp\Client;
use GuzzleHttp\Cookie\FileCookieJar;

/**
 * https://github.com/stackoverflowin/CloudFlare-PHP-Bypass/blob/master/cloudflare.class.php
 */
...
class CloudFlare
{
     ...
     * @param FileCookieJar $response instance of response class
    ...
    public function __construct($targetSite, $cookies = [false, "cookie.txt"])
    {
        ...
        if(isset($cookies[0]) && $cookies[0])
        {
            ...
            $file = $cookies[1];
            $this->cookieJar = new FileCookieJar($file);
            $config = [
     ...
     * @param  Client $response instance of response class
     * @return bool          protected or not
     */
