...
class SubdomainController extends ClientApiController
{
     ...
     * @throws DisplayException
     */
    public function sync(SubdomainRequest $request, Server $server, $id): array {
        $id = (int) $id;
    ...
    public function delete(SubdomainRequest $request, Server $server, $id): array
    {
        ...
        if (!$subdomain[0]->deletable) {
            throw new DisplayException('This subdomain cannot be deleted.');
        }
