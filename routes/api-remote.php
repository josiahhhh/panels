...
Route::group(['prefix' => '/backups'], function () {
    ...
    Route::get('/{backup}/b2', [Remote\Backups\B2BackupRemoteUploadController::class, 'index']);
    Route::post('/{backup}/restore', [Remote\Backups\BackupStatusController::class, 'restore']);

    Route::post('/{backup}/restore/{id}/completed', [Remote\Iceline\RestoreBackupController::class, 'index']);
});
